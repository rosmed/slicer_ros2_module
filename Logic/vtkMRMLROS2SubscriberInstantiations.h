...
typedef vtkMRMLROS2SubscriberVTKImplementation<geometry_msgs::msg::PoseStamped, vtkMatrix4x4> vtkMRMLROS2SubscriberPoseStamped;

typedef vtkMRMLROS2SubscriberNativeImplementation<std_msgs::msg::String, std::string> vtkMRMLROS2SubscriberString;
