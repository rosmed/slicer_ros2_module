...
VTK_MRML_ROS_PUBLISHER_NATIVE_CXX(float, std_msgs::msg::Float64, Float);

VTK_MRML_ROS_PUBLISHER_VTK_CXX(vtkIntArray, std_msgs::msg::Int64MultiArray, Int64MultiArray);
VTK_MRML_ROS_PUBLISHER_VTK_CXX(vtkDoubleArray, std_msgs::msg::Float64MultiArray, Float64MultiArray);
